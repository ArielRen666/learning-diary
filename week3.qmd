...
Various errors that may exist in remote sensing images (e.g., due to factors such as sensors, atmosphere, terrain, etc.) and how to correct them through different techniques. Including **Geometric correction** (coordinate system & distortion), **Atmospheric correction** (atmospheric scattering & absorption), **Orthorectification/Topographic correction** (terrain deformation), **Radiometric correction** (convert digital value into spectral radiance).
