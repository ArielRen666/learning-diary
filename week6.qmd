...
This video shows how to perform unsupervised image classification in ArcGIS Pro. Unsupervised image classification in remote sensing uses clustering algorithms to group similar pixels in an image without using any prior training data.
