...
![Diagram of a passive sensor versus an active sensor. Source: [Appliedsciences Nasa](https://appliedsciences.nasa.gov/sites/default/files/2024-03/McCartney_SXSW_edited_SC.pdf).](images/1.1.2activePassive.png){width="75%"}
...
![The relationship between a plant's health status and the gradual increase in NDVI value. Source: [Cropin](https://www.cropin.com/blogs/ndvi-normalized-difference-vegetation-index).](images/2.1.4plant.jpg){width="77%"}
